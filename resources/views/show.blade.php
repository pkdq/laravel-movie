...
@section('content')
	<div class="movie-info border-b border-gray-800">
		<div class="container mx-auto px-4 py-16 flex flex-col md:flex-row">
			<img src="/img/parasite.jpg" alt="parasite" class="w-64">
			<div class="md:ml-24">
				...
				<div class="mt-12">
					...
					<div class="flex mt-4">
						<div>
							<div>ABC</div>
							<div class="text-sm text-gray-400">ASBCS</div>
						</div>
				...
				<div class="mt-12">
					<button class="flex items-center bg-orange-500 text-gray-900 rounded font-semibold px-5 py-4 hover:bg-orange-600 transition ease-in-out duration-150">
						...
						<span class="m2">Play Trailer</span>
					</button>
				</div>
			</div>
		</div>
		...
		<div class="container mx-auto px-4 py-16">
			...
			<div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-16">
				<div class="mt-8">
					...
					<div class="mt-2">
						<a href="#" class="text-lg mt-2 hover:text-gray-300">Actor Real Name</a>
