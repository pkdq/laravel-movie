...
class ViewPeoplesTest extends TestCase
{
    /** @test */
    public function the_index_page_shows_the_correct_info()
    {
        Http::fake([
            'https://api.themoviedb.org/3/person/popular?page=1' => $this->fakePopularPeople(),
        ]);
    ...
    {
        Http::fake([
            'https://api.themoviedb.org/3/person/popular?page=2' => $this->fakePopularPeoplePage2(),
        ]);

        $response = $this->get('people/page/2');
    ...
    {
        Http::fake([
            'https://api.themoviedb.org/3/person/2888' => $this->fakePeople(),
        ...
        $response = $this->get(route('people.show', 2888));
        $response->assertSuccessful();
        $response->assertSee('Will Smith');
    ...
    private function fakePopularPeoplePage2()
    {
        return Http::response([
            'results' => [
                [
